...
You can add a task with no start time or end time by typing the following command<br>
...
You can add a task which must be done by a certain deadline. You can specify the deadline after the keyword `by`.<br>
...
If you wish to update or enhance the description of a task, you can use the following commandt.<br>
...
If a task no longer has a deadline or specified time, you can remove the previous time restrictions by typing the following command:<br>
...
Now record this in Agendum by identifying the index of the task and type in the following command:<br>
Format: `mark INDEX...`
...
To mark multiple tasks, try out any of the following examples:<br>
...
You might change your mind and want to continue working on a recently completed task. <br>
To reflect these changes in Agendum, follow this command: <br>
Format: `unmark INDEX...`
...
You can remove these tasks from the task list by using the following command:<br>
Format: `delete INDEX...`  
...
Perhaps you want to type a command faster, or change the name of a command to suit your needs; fret not, Agendum allows you to define your own aliases for commands.<br>
...
Is a current alias inconvenient? Have you thought of a better one? Or perhaps you are thinking of using an alias for another command. <br>
To remove a previously defined alias, type:<br>
...
The task list data will be saved to the specific directory, and future data will be saved in that location.<br>
...
After relocating Agendum’s data files on your desktop computer, you might want to load the exact same copy of Agendum’s task list from the Dropbox file on your laptop. <br>
Agendum also offers you the flexibility to choose which data files to import. Use the following command:<br>
...
To leave Agendum, type `exit`. You do not have to worry about saving your data as Agendum automatically does it.<br>
Format: `exit`  
